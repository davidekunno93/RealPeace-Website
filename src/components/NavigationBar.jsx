            ...
            <div className="navbar flx-r flx-wrap gainslite-bg">
                <>
                    <div className="leftnav flx-r flx-wrap black-text">
                        <Link className="m-auto" to="/"><img className="rp-icon mt-1 mx-6" src="https://i.imgur.com/fAPatZz.png" /></Link>
                    </div>
                    ...
                    <div id="responsive-nav" className="wide-nav responsive-nav leftnav flx-4 flx-r flx-wrap black-text">
                        ...
                        <Link onClick={() => closeNavBar()} to="/under-construction" className="mt-3hh black-link small"><button className="wide100-respond left-text-respond nav-btn2">PRODUCTS</button></Link>
                    ...
                    {/* <div className="narrow-invisible rightnav flx-r just-se black-text">
                        <Link to="/login" className="black-link nav-btn mt-2h small"><button className="mx-2 right-btn">LOGIN</button></Link>
                        <Link to="/register" className="black-link nav-btn small"><button className="mx-2 inline v-align mt-2h right-btn"><p className="m0 v-align inline mr-2">SIGN UP</p><img className="v-align signin-arrow-img" src="https://i.imgur.com/uYb4KCt.png" /></button></Link>
                    </div> */}
                </>
            </div>
        </>
